"""
Django settings for pgp_mis project.
...
WSGI_APPLICATION = 'pgp_mis.wsgi.application'
...
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = 'programming:programmingDashboard'
